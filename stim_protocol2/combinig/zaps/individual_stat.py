...
for idx, dur in enumerate(hz):
    ...
    for n in range(p_num):
        l = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/%i(%i)/loglikelihood.txt"
                       % (dur, n))
        Ra = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/1(%i)/fixed_params/Ra(0).txt"
                        %(n), dtype=str)
        cm = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/1(%i)/fixed_params/cm(0).txt"
                        %(n), dtype=str)
        gpas = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/1(%i)/fixed_params/gpas(0).txt"
                          %(n), dtype=str)

        inf = load_inference(l,"/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/%i(%i)" %(dur,n), Ra, cm, gpas)
        inf.run_evaluation()
...
np.savetxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/cm_sharpness.txt", result_cm)
np.savetxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/cm_broadness.txt", result_cm_b)
np.savetxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/gpas_sharpness.txt", result_gpas)
np.savetxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/combinig/zaps/gpas_broadness.txt", result_gpas_b)
