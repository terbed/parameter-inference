...
database = tb.open_file("/Users/Dani/TDK/parameter_estim/stim_protocol2/combining5/paramsetup.hdf5", mode="w")
...
for item in hz:
    ...
    working_path = "/Users/Dani/TDK/parameter_estim/stim_protocol2/combining5/zaps/%i" % item
