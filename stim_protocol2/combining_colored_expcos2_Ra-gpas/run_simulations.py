...
def aut_corr_func(x):
    return p[0]*np.exp(-np.abs(x)/p[1])*np.cos(2*np.pi/p[2]*np.abs(x)+p[3])
...
database = tb.open_file("/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_expcos2_Ra_gpas/paramsetup.hdf5", mode="w")
...
for item in hz:
    ...
    working_path = "/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_expcos2_Ra_gpas/sins/%i" % item
...
for item in duration:
    ...
    working_path = "/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_expcos2_Ra_gpas/steps/%i" % item
