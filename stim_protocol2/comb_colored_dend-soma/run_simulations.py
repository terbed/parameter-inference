...
from module.simulation import real_morphology_model_sdend_rsoma
...
model = real_morphology_model_sdend_rsoma
...
database = tb.open_file("/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_dend-soma/paramsetup.hdf5", mode="w")
...
for item in hz:
    ...
    working_path = "/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_dend-soma/sins/%i" % item
...
for item in duration:
    ...
    working_path = "/Users/Dani/TDK/parameter_estim/stim_protocol2/combining_colored_dend-soma/steps/%i" % item
