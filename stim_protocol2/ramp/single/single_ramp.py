...
inference = IndependentInference(data, Ra_cm_gpas, working_path="/Users/Dani/TDK/parameter_estim/stim_protocol2/ramp/single", speed="min")
...
logli = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/ramp/single/loglikelihood/summed_ll(1).txt")
