...
noise_sigma = 0.5
stim = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/steps/400/stim.txt")
...
inference = IndependentInference(data, Ra_cm_gpas, working_path="/Users/Dani/TDK/parameter_estim/stim_protocol2/steps/400/", speed='min')
...
logli = np.loadtxt("/Users/Dani/TDK/parameter_estim/stim_protocol2/steps/400/loglikelihood/loglikelihood(4).txt")
