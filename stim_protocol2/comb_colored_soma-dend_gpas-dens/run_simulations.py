...
from module.simulation import real_morphology_model_ssoma_rdend_spatial
...
model = real_morphology_model_ssoma_rdend_spatial
...
database = tb.open_file("/home/szabolcs/parameter_inference/stim_protocol2_v24/comb_colored_soma-dend_gpas-dens/paramsetup.hdf5", mode="w")
...
for item in hz:
    ...
    working_path = "/home/szabolcs/parameter_inference/stim_protocol2_v24/comb_colored_soma-dend_gpas-dens/sins/%i" % item
...
for item in duration:
    ...
    working_path = "/home/szabolcs/parameter_inference/stim_protocol2_v24/comb_colored_soma-dend_gpas-dens/steps/%i" % item
