...
p_range = [[30, 300], [0.00002, 0.0005], [0.4, 10.]]
p_mean = [150., 0.0002, 3.]  # Fixed prior mean
...
initial_params = [{'Ra': None, 'gpas': None, 'cm': None}]
...
database = tb.open_file("/home/szabolcs/parameter_inference/exp/inference_w/paramsetup.hdf5", mode="w")
...
# RUN INFERENCE --------------------------------------------------------------------------------------------
working_path = "/home/szabolcs/parameter_inference/exp/inference_w"


if __name__ == '__main__':
    run_protocol_simulations(model=exp_model, target_traces=target_traces, noise_std=noise_std , param_set=prior_set,
