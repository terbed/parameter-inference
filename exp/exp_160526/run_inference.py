...
p_range = [[50., 200.], [0.00002, 0.0006], [[1., 5.]]]
p_mean = [100., 0.0003, 2.]     # Fixed prior mean
...
p = [ 2.79388925e-02,  3.91934291e+02, 9.54439765e+02, -9.99502661e+01]
...
def aut_corr_func(x):
    return p[0]*np.exp(-x/p[1])*np.cos(2*np.pi/p[2]*x+p[3])
