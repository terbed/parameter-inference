...
working_path = "/Users/admin/PROJECTS/SPE/parameter-inference/exp/exp_160526w"
...
if __name__ == '__main__':
    run_protocol_simulations(model=model, target_traces=target_traces, noise_std=noise_std, param_set=prior_set,
