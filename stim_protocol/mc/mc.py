...
# Only for plotting
pRa = RandomVariable(name='Ra', range_min=75, range_max=225, resolution=80, mean=150, sigma=20)
...
inv_covmat = np.genfromtxt('/Users/Dani/TDK/parameter_estim/stim_protocol/narrow_invcovmat.csv')
print "Done!"
...
for i in range(num_of_iter):
    ...
    if i == 0:
        ...
        plt.savefig('/Users/Dani/TDK/parameter_estim/stim_protocol/narrow_noised.png')
        plt.show()
    ...
    inference = DependentInference(data, Ra_gpas)
...
np.savetxt(fname='/Users/Dani/TDK/parameter_estim/stim_protocol/mc/narrow/Ra_stat.txt', X=Ra_stat,
           header=header1 + 'sigma\tdiff\taccuracy\tsharper\tsigma_err', delimiter='\t')
np.savetxt(fname='/Users/Dani/TDK/parameter_estim/stim_protocol/mc/narrow/gpas_stat.txt', X=gpas_stat,
           header=header2 + '\nsigma\tdiff\taccuracy\tsharper\tsigma_err', delimiter='\t')

# Plot statistics
plot_stat(Ra_stat, pRa, path='/Users/Dani/TDK/parameter_estim/stim_protocol/mc/narrow')
plot_stat(gpas_stat, pgpas, path='/Users/Dani/TDK/parameter_estim/stim_protocol/mc/narrow')
