...
for i in range(100):
    ...
    if statmat[1][i] > 10:
        ...
        plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/outstanding" + str(cm_num) + "_" + str(i) + ".png")

sys.stdout = open('/Users/Dani/TDK/parameter_estim/wn2/statistics/statistic_result' + str(cm_num) + '.txt', 'w')
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/dist" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/p_times" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/sharp_times" + str(cm_num) + ".png")
