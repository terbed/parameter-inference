...
plt.savefig("/Users/Dani/TDK/param_estim/wn2/statistics/lower_noise/dist" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/param_estim/wn2/statistics/lower_noise/p_times" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/param_estim/wn2/statistics/lower_noise/sharp_times" + str(cm_num) + ".png")
