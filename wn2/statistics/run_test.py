...
for i in range(100):
    ...
    if statmat[1][i] > 10:
        ...
        plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/lower_noise/outstanding" + str(cm_num) + "_" + str(i) + ".png")

sys.stdout = open('/Users/Dani/TDK/parameter_estim/wn2/statistics/lower_noise/statistic_result' + str(cm_num) + '.txt', 'w')
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/lower_noise/dist" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/lower_noise/p_times" + str(cm_num) + ".png")
...
plt.savefig("/Users/Dani/TDK/parameter_estim/wn2/statistics/lower_noise/sharp_times" + str(cm_num) + ".png")
